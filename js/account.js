...
const currentUserNameLast = localStorage.getItem("LastName");
const currentUserEmail = localStorage.getItem("Email");
console.log(localStorage.getItem("FirstName"));
console.log(localStorage.getItem("LastName"));
userloginInfo.innerHTML += `<h3 class="font-semibold capitalize text-lg">
${currentUserName}${" "}${currentUserNameLast}
</h3>
...
closeButton.addEventListener("click", (event) => {
    ...
    mainImage.style.backgroundImage = "../img/EcoStore.png";
